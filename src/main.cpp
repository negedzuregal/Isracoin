...
bool IsStandardTx(const CTransaction& tx, string& reason)
{
    ...
    BOOST_FOREACH(const CTxIn& txin, tx.vin)
    {
    	// UPDATE FROM BITCOIN REFERENCE CLIENT :
    	//	See (https://github.com/bitcoin/bitcoin/commit/4d79098ad548874ca6e4c09d873fc2f481e6edb4#diff-7ec3c68a81efff79b6ca22ac1f1eabbaR494)
    	// -------------------------------------------------------------------
